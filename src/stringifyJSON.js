...
console.log('JSON' + JSON.stringify(parsableStuff));
var expected = JSON.stringify(parsableStuff);

console.log('Mine' + stringifyJSON(parsableStuff));
var actual = stringifyJSON(parsableStuff);
